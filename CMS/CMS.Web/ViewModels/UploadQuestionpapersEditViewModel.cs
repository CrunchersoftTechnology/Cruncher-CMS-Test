...
{
    public class UploadQuestionpapersEditViewModel
    {
        public int UploadQuestionpapersId { get; set; }
        ...
        [Required(ErrorMessage = "The Questionpapers Date field is required.")]
        [Display(Name = "Questionpapers Date")]
