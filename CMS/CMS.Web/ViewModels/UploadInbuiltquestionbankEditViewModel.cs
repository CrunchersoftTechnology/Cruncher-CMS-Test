...
{
    public class UploadInbuiltquestionbankEditViewModel
    {
        public int UploadInbuiltquestionbankId { get; set; }
        ...
        [Required(ErrorMessage = "The Inbuiltquestionbank Date field is required.")]
        [Display(Name = "Inbuiltquestionbank Date")]
