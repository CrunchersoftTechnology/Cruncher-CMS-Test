...
{
    public class UploadReferencebooksEditViewModel
    {
        public int UploadReferencebooksId { get; set; }
        ...
        [Required(ErrorMessage = "The Referencebooks Date field is required.")]
        [Display(Name = "Referencebooks Date")]
